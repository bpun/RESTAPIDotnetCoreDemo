            ...
            modelBuilder.Entity("DotnetCore.RestPAPIDemo.Model.Entities.Schedule", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2016, 12, 12, 15, 41, 8, 614, DateTimeKind.Local));

                    b.Property<DateTime>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2016, 12, 12, 15, 41, 8, 620, DateTimeKind.Local));
